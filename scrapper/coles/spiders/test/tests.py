...
class TestColesSpider(unittest.TestCase):
    ...
    def test_get_drinks_homepages_urls(self):
        ...
        urls = coles._get_homepages_url(response)
    ...
    def test_get_search_url(self):
        ...
        response = coles_response('fixtures/drinks_list.html')
        url = coles._get_search_url(response)
    ...
    def test_extract_search_parameters(self):
        ...
        order_by, begin_index, catalogId, categoryId = coles._extract_search_parameters(search_dirty_parameters)
    ...
    def test_get_products_and_next_page(self):
        ...
        self.assertTrue("beginIndex=200" in search_url)
    ...
    def test_get_product_detail(self):
        ...
        coles.regions = [] 
        product = coles._get_product_detail(response)
        expected_info = {u'Retail Limit:': u'* Percentage Daily Intake per serving. Percentage Daily Intakes are based on an average adult diet of 8700 kJ. Your daily intakes may be higher or lower depending on your energy needs.', u'Allergen:': u'Contains Barley', u'Serving Size:': u'375ml', u'Size:': u'20', u'Ingredients:': u'Malted barley, hops, yeast and water.', u'Servings Per Pack:': u'1.0'}
    ...
    def test_get_product_price_per_region_same_price(self):
        ...
        coles._get_driver = Mock()        
        coles._get_price_region = Mock(return_value='$14.00')        
        product = coles._get_product_price_region(region, product)
        ...
        self.assertEquals(product['prices_region'][1]['postcode'], '3182')
        self.assertEquals(product['prices_region'][0]['price'], '$14.00')
        self.assertEquals(product['prices_region'][1]['price'], '$14.00')
    
    def test_get_product_price_different_per_region(self):
        coles = ColesSpider(url='http://shop.coles.com.au/online/national/drinks')
        product = Product(id=84624, general_price=u'10.00', has_price_difference=False, redirect_url = 'http://shop.coles.com.au/webapp/wcs/stores/servlet/national/pepsi-max-soft-drink-cola-375ml-cans-7366022p', prices_region= [])
        region = Region(state='VIC', score='8.029414', collectionpoint='',
                suburb='ST KILDA SOUTH', country='AU', zone_id= '0645HD',
        ...
        coles._get_price_region = Mock(return_value='$24.00')        
        product = coles._get_product_price_region(region, product)
        ...
        self.assertEquals(product['prices_region'][1]['postcode'], '3182')
        self.assertEquals(product['prices_region'][0]['price'], '$14.00')
        self.assertEquals(product['prices_region'][1]['price'], '$24.00')
    ...
    def test_generate_price_region_url(self):
        ...
        region = Region(state='VIC', score='8.029414', collectionpoint='',
                ...
                lon='144.98116', lat='-37.872868', service_type='HD', 
                postcode='3182', webstore_id='0645', id='14854')
        price_region_url = coles._get_price_per_region_url(region, product)
    ...
    def test_get_region(self):
        ...
        coles_region._get_region(response)
